...
public class Main {
	...
	public static boolean addDepartment(String newName) throws DuplicateGuildNameException, EmptyGuildNameException {
		...
		try {
			...
			} else if (myDatabase.isExists(newName)) {
				throw new DuplicateGuildNameException();
			} else {
				myDatabase.createDepartment(newName);
				System.out.println(newName + " department has been created");
			}
		} catch (EmptyGuildNameException emptyExt) {
			System.out.println(emptyExt);
			return false;
		}catch (DuplicateGuildNameException duplicExt) {
			System.out.println(duplicExt);
			return false;
		}
	...
	public static void removeDepartmentFromDatabase(int index) {
		...
		getUnassignedDepartment().addMultipleMembers(myDatabase.getDepartment(index).getAllMembers()); 
		...
		System.out.println("the department is removed and that all members are moved to the unassigned department.");
	}
